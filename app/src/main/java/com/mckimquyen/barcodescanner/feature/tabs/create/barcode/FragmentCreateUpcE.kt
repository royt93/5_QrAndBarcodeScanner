...
import com.mckimquyen.barcodescanner.databinding.FCreateUpcEBinding
...
class FragmentCreateUpcE : FragmentBaseCreateBarcode() {
    private var _binding: FCreateUpcEBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FCreateUpcEBinding.inflate(inflater, container, false)
        return binding.root
    }
