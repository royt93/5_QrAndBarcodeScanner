...
import com.mckimquyen.barcodescanner.databinding.FCreateEan8Binding
...
class FragmentCreateEan8 : FragmentBaseCreateBarcode() {
    private var _binding: FCreateEan8Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FCreateEan8Binding.inflate(inflater, container, false)
        return binding.root
    }
