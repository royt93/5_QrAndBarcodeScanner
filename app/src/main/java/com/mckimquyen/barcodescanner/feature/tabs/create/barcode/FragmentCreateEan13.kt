...
import com.mckimquyen.barcodescanner.databinding.FCreateEan13Binding
...
class FragmentCreateEan13 : FragmentBaseCreateBarcode() {
    private var _binding: FCreateEan13Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FCreateEan13Binding.inflate(inflater, container, false)
        return binding.root
    }
