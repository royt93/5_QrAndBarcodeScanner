...
import com.mckimquyen.barcodescanner.databinding.FCreateCodabarBinding
...
class FragmentCreateCodabar : FragmentBaseCreateBarcode() {
    private var _binding: FCreateCodabarBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FCreateCodabarBinding.inflate(inflater, container, false)
        return binding.root
    }
