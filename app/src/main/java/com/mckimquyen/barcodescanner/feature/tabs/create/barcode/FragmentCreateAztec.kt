...
import com.mckimquyen.barcodescanner.databinding.FCreateAztecBinding
...
class FragmentCreateAztec : FragmentBaseCreateBarcode() {
    private var _binding: FCreateAztecBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FCreateAztecBinding.inflate(inflater, container, false)
        return binding.root
    }
