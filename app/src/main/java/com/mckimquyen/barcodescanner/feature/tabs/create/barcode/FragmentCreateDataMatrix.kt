...
import com.mckimquyen.barcodescanner.databinding.FCreateDataMatrixBinding
...
class FragmentCreateDataMatrix : FragmentBaseCreateBarcode() {
    private var _binding: FCreateDataMatrixBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FCreateDataMatrixBinding.inflate(inflater, container, false)
        return binding.root
    }
